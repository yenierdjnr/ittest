      ...
      <div className={ styles.row }>
        <div className={ styles.col }>
          ...
          <div className={ styles.iframe }>
            <iframe className={ styles.responsiveItem } src="https://www.google.com/maps/embed?pb=!1m0!3m2!1sen!2sus!4v1484679233708!6m8!1m7!1sxEbQtSYgA6cAAAQ7LvxqHw!2m2!1d29.6553720321947!2d-82.4234055060682!3f174.43994796036515!4f-10.892615850059997!5f0.7820865974627469" align="center" allowfullscreen>
            </iframe>
          </div>
