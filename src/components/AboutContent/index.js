...
const AboutContent = props => {
  return (
    <section className={ styles.container }>
        ...
        <Para className={ styles.tourContent } color={ styles.greyDark } >In Gainesville? Let us know you’re coming by for a tour: <a className={ styles['email'] } href="support@itpro.tv">support@itpro.tv</a>.</Para>
