    ...
    <section className={ `${styles['capsule']} ${ styles.maps }` }>
      ...
      <div className={ styles.mapRow }>
        ...
        <div className={ `${styles['col-lg-6']} ${ styles.uk }` }>
          ...
          <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2519.738013690154!2d-0.17426918433557312!3d50.83601646738868!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0xe0572e20ddc7d139!2sFreedom+Works+-+Creative+Hub!5e0!3m2!1sen!2sus!4v1518126637032" width="450" height="550" frameborder="0" allowfullscreen></iframe>
        </div>
      </div>
    </section>
  );
