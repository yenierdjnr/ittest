      ...
      <div className={ styles.colLeft }>
        ...
        <div className={ styles.row }>
          <div className={ styles.col12 }>
            <Hx styles={ styles.subtitle } color={ styles.offBlack } size="3">Technado: The Weekly Tech News Wrap-up</Hx>
      ...
      <div className={ styles.colRight }>
        ...
        <div className={ styles.row }>
          <div className={ `${styles.col12} ${styles.askSME}` }>
            <Hx styles={ styles.subtitle } color={ styles.offBlack } size="3">Ask SME Anything: Q&amp;A with IT Experts</Hx>
