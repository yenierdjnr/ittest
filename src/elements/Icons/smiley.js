...
const IconSmiley = () => {
  ...
  return (
    <svg width="109.2" viewBox="0 0 218.4 218.4">
      ...
      <ellipse cx="104.95" cy="106.17" rx="92.84" ry="53.6" transform="translate(-39.47 143.98) rotate(-60)" fill="#d8d8e5" stroke="#151746" strokeMiterlimit="10" strokeWidth="2"/>
      <ellipse cx="113.45" cy="112.23" rx="92.84" ry="53.6" transform="translate(-40.46 154.37) rotate(-60)" fill="#fff" stroke="#151746" strokeMiterlimit="10" strokeWidth="3"/>
